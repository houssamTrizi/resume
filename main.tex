...
{\customcvproject{Batch Pricing Project}{Aug 2017 - Present}{}{}{}{}{}
  {\begin{itemize}
    ...
    \item Used Jenkins pipeline for the CI/CD of the project
...
{\begin{itemize}
  \item Developed an external email based pricing API used directly by clients to price equity structured products.
  \item Implemented generic products mapping system. (using anticipated implementation of Python 3.7's data classes (PEP 557))
   \end{itemize}
}
...
\begin{minipage}{\maincolumnwidth}%
	\small{
    	\begin{itemize}
          ...
          \item CI/CD \& version control: Jenkins, Docker, JFrog Artifactory, Git. 
